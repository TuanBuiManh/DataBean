...
public class DataBean {
    ...
    // So hieu loi va cac thong bao loi
    private int error = 0;
    ...
    */
    ...
    /*
    Phuong thuc lay ten nguoi dung
     */
    ...
    /*
    Phuong thuc thiet lap mat khau cap CSDL
    ...
    @paaram drv Ten driver truy cap CSDL
     */
    ...
    /*
    Phuong thuc tra ve ten cua driver de truy cap CSDL
     */
    ...
    public void insert(Properties pField){
        ...
        int t = 0;
        // Liet ke ten cac cot theo thu tu tu gia tri them vao
    ...
    public void update(Properties pField){
        ...
        int t = 0;
        // Liet ke ten cac cot theo thu tu gia tri can cap nhat
        for (int i = 0; i < fields.size(); i++){
            String s = pField.getProperty(fields.get(i));
